...
public abstract class StatisticObject {
    ...
    /**
     * Resets the counter for observations. The point of simulation time this
     * method was called will be stored and can be retrieved using method
     * <code>resetAt()</code>.
     */
    public void reset() {
    ...
    /**
     * Shows the point in time when the last reset of this reportable was made.
     *
